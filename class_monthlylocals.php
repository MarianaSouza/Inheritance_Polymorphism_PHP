...
class MonthlyLocals extends SelfFunded{
...
// 	$monthly = new MonthlyLocals('Anne', 'Thompson', 'annt@gmail.com', '14/07/1991', '1 657 7894559 12', '1 704 7894559', 'Canada, BC, Vancouver, 1236, 7895, Howe St',
// 		'IELTS', 'Local', 111, 'Web Development','21/01/2017', 1000, 7000, "Cash");
// 	//echo $quaterly->get_startDateDMY()."<br/>";
// 	echo $monthly->payment()."<br/>";
// 	echo "<hr/>";
// 	echo "Payment Option: ". $monthly->get_paymentOption()."<br/>";
// 	echo "<pre>";
// 	print_r($monthly);
// 	echo "</pre>";
