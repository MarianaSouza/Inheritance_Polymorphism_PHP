...
class Internationals extends Students{
...
// 	//$local1 = new Locals('21/01/2017', 1000, 4500);
// 	//echo  $local1->get_startDateMDY()."<br/>";
// 	//echo  $local1->get_startDate->printDateDMY()."<br/>";
// 	//echo  $local1->get_startDate->printDateMonthDY()."<br/>";

// 	$international = new Internationals('Mathew', 'Smith', 'mathews@gmail.com', '20/04/1990', '1 657 7894559 12', '1 704 7894559',
// 		'Canada, BC, Vancouver, 1236, 7895, Howe St','IELTS', 'International', 112, 'Design', '15/07/2017', 1000, 3250);
